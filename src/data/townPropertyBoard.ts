...
const ALBANY: TownPropertyBoard = {
  ...
  listings: [
    ...
    { id: "202614424", price: 299900, address: "538 New Scotland Avenue", beds: 5, sqft: 1720, units: 2, propertyType: "Duplex", agentName: "Steve Duggan", brokerage: " Capital", agentId: "steve-duggan", listingUrl: "", listedAt: "2026-04-03" },
  ...
  agents: [
    ...
    { id: "steve-duggan", name: "Steve Duggan", brokerage: " Capital", activeCount: 1, soldLast12: 0 },
