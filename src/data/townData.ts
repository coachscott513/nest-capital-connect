...
export const cliftonParkData: TownData = {
  ...
  marketActivityLastChecked: "Dec 31, 2025",
  marketSnapshot: [
    { label: "Active Listings", value: "42", change: "available homes" },
    { label: "Median Sale Price", value: "$388,750", change: "Nov 2025" },
    { label: "Days on Market", value: "6", change: "very fast" },
    { label: "Pending Sales", value: "24", change: "under contract" },
  ],
  recentlySold: [
