...
export const troyData: TownData = {
  ...
  marketSnapshot: [
    ...
    { label: "Median Sale Price", value: "$259,900", change: "+0.1% YoY" },
    { label: "Days on Market", value: "18", change: "steady" },
...
export const saratogaData: TownData = {
  ...
  marketActivityLastChecked: "Dec 31, 2025",
  marketSnapshot: [
    { label: "Recent Sales (30-90 days)", value: "46", change: "very active" },
...
export const schenectadyData: TownData = {
  ...
  marketActivityLastChecked: "Dec 31, 2025",
  marketSnapshot: [
    { label: "Recent Sales (30-90 days)", value: "77", change: "very active" },
    { label: "Median Sale Price", value: "$317,000", change: "+7.9% YoY" },
...
export const amsterdamData: TownData = {
  ...
  marketActivityLastChecked: "Dec 31, 2025",
  marketSnapshot: [
    { label: "Recent Sales (30-90 days)", value: "10", change: "active market" },
    { label: "Median Sale Price", value: "$264,000", change: "+15.3% YoY" },
    { label: "Days on Market", value: "20", change: "steady" },
...
export const queensburyData: TownData = {
  ...
  marketActivityLastChecked: "Dec 31, 2025",
  marketSnapshot: [
    { label: "Recent Sales (30-90 days)", value: "21", change: "active market" },
    { label: "Median Sale Price", value: "$424,500", change: "+3.9% YoY" },
    { label: "Days on Market", value: "7", change: "very fast" },
