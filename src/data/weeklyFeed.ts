...
export const weeklyFeed: WeeklyFeedItem[] = [
  ...
  {
    title: "Downtown Schenectady restaurant week breaks attendance record",
    summary:
      "Local operators report the strongest turnout in five years as new concepts open along State Street.",
    description:
      "Local operators report the strongest turnout in five years as new concepts open along State Street.",
    type: "news",
    date: "This week",
  ...
  {
    title: "Saratoga County approves mixed-use development on Route 9",
    summary:
      "New 180-unit residential project with ground-floor retail clears final planning board review.",
    description:
      "New 180-unit residential project with ground-floor retail clears final planning board review.",
    type: "news",
    town: "Saratoga",
    date: "This week",
    scope: "region",
    source_name: "WNYT NewsChannel 13",
    external_article_url: "https://wnyt.com/",
    original_url: "https://wnyt.com/",
    published_at: "2026-05-27",
    categoryBadgeOverride: "DEVELOPMENT // LOCAL NEWS",
    startDate: "2026-05-25",
    endDate: "2026-06-25",
  },
  {
    title: "Albany High basketball star commits to Division I program",
    summary:
      "Capital Region athlete signs national letter of intent — local college coaches react.",
    description:
      "Capital Region athlete signs national letter of intent — local college coaches react.",
    type: "news",
    town: "Albany",
    ...
    categoryBadgeOverride: "SPORTS // LOCAL NEWS",
    startDate: "2026-05-24",
    endDate: "2026-06-24",
  },
  {
    title: "Troy waterfront concert series returns this summer",
    summary:
      "Free Friday-night shows along River Street return with an expanded lineup and new food vendors.",
    description:
      "Free Friday-night shows along River Street return with an expanded lineup and new food vendors.",
    type: "news",
    town: "Troy",
    ...
    external_article_url: "https://spectrumlocalnews.com/nys/capital-region",
    original_url: "https://spectrumlocalnews.com/nys/capital-region",
    published_at: "2026-05-26",
    categoryBadgeOverride: "EVENTS // LOCAL NEWS",
    startDate: "2026-05-24",
    endDate: "2026-08-31",
  },
  {
    title: "Capital Region housing inventory ticks up for first time in 18 months",
    summary:
      "New listings rise across Albany, Saratoga, and Schenectady counties as spring market opens.",
    description:
      "New listings rise across Albany, Saratoga, and Schenectady counties as spring market opens.",
    type: "news",
    ...
    categoryBadgeOverride: "REAL ESTATE // LOCAL NEWS",
