...
const TroyMultiUnit = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from("leads").insert({
        ...
        email: email,
        type: "troy-multi-unit-waitlist",
        message: "Interested in Troy Multi-Unit properties"
      });
  ...
  return (
    <MainLayout>
      <Helmet>
        <title>Troy Multi-Unit Homes for Sale | Coming Soon</title>
        <meta name="description" content="Search Troy's best multi-unit properties. Includes under-rented buildings, BRRRR opportunities, and high cap rate inventory favored by value-add investors." />
        <meta name="keywords" content="troy multi family homes for sale, troy duplex, troy triplex, troy investment property, troy ny multi unit" />
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/10">
          <div className="container mx-auto px-4 py-20 text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 font-playfair">
              Troy Multi-Unit Homes for Sale
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
              Search Troy's best multi-unit properties. Includes under-rented buildings, 
              BRRRR opportunities, and high cap rate inventory favored by value-add investors.
            </p>
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-sm text-muted-foreground mt-3">
                Be the first to know when Troy multi-unit listings go live.
              </p>
            </div>
          </div>
        </section>
