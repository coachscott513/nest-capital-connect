          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90 font-semibold px-8 py-6 text-lg" asChild>
                <a href={cliftonParkData.remaxSearchUrl} target="_blank" rel="noopener noreferrer">View Live Clifton Park Listings <ExternalLink className="w-5 h-5 ml-2" /></a>
              </Button>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            {!iframeError ? (
              ...
              <Card className="max-w-2xl mx-auto p-8 text-center">
                ...
                <Button size="lg" asChild><a href={cliftonParkData.remaxSearchUrl} target="_blank" rel="noopener noreferrer">Open RE/MAX Search</a></Button>
              </Card>
            )}
          </div>
        </section>
