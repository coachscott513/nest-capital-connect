      ...
      <section className="px-[5%] py-20 border-t border-border">
        <div className="text-center max-w-[800px] mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
            Join the Conversation <span className="text-primary">@CapitalDistrictNest</span>
          </h2>
          <p className="text-2xl md:text-3xl font-bold text-primary mb-4">5k+ Followers Across Platforms</p>
          <p className="text-muted-foreground">Follow us for market insights, new listings, and Capital District real estate tips.</p>
        </div>

        {/* Social Grid - Instagram-style cards */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-10">
          {[
            { type: "Market Update", caption: "Albany prices up 8% YoY" },
            { type: "New Listing", caption: "Troy Victorian - $189k" },
            { type: "Client Win", caption: "Closed in 22 days!" },
            { type: "Investment Tip", caption: "Cash flow > appreciation" },
          ].map((post, i) => (
            <div key={i} className="aspect-square bg-card border border-border rounded-xl overflow-hidden relative group cursor-pointer hover:border-primary transition-colors">
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <div className="text-xs text-primary font-semibold uppercase mb-1">{post.type}</div>
                <p className="text-foreground font-medium text-sm">{post.caption}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <a href="https://www.instagram.com/capitaldistrictnest" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-foreground text-background px-6 py-3 rounded-full font-bold hover:scale-105 transition-transform">
          ...
          <a href="https://www.facebook.com/capitaldistrictnest" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 border border-border text-foreground px-6 py-3 rounded-full font-bold hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors">
