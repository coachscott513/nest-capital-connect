          ...
          <section className="py-8 px-4">
            <div className="max-w-[1000px] mx-auto">
              ...
              <div className="my-8 text-center bg-muted/30 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-2">Get Multi-Unit Listings + Cash-Flow Analysis</h3>
                <p className="text-muted-foreground mb-4">We'll send you the best-performing multi-unit deals weekly.</p>
                <iframe
                  src="YOUR_BOLDTRAIL_FORM_URL?tag=CDN_MultiUnit&campaign=MultiUnit_Alerts"
                  title="Multi-Unit Leads"
