      ...
      <section className="pt-32 pb-8 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-amber-50 flex items-center justify-center"><TrendingUp className="w-7 h-7 text-gray-900" /></div>
          ...
          <p className="text-lg text-gray-500 max-w-2xl">Break down rent, expenses, cash flow, cap rate, and return.</p>
        </div>
      </section>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100 text-center">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Cash Invested</p>
                <p className="text-2xl font-bold text-gray-900">${fmt(cashInvested)}</p>
              </div>
              <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100 text-center">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Annual Debt Service</p>
                <p className="text-2xl font-bold text-gray-900">${fmt(annualDebt)}</p>
              </div>
            </div>
          </div>
        </div>
