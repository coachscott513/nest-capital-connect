      ...
      <section className="pt-32 pb-8 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center"><Mountain className="w-7 h-7 text-foreground" /></div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className={`p-6 rounded-2xl text-center ${estimatedEquity >= 0 ? "bg-secondary border border-emerald-100" : "bg-red-50 border border-red-100"}`}>
