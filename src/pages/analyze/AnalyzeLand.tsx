      ...
      <section className="pt-32 pb-8 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-full bg-secondary flex items-center justify-center"><Mountain className="w-7 h-7 text-foreground" /></div>
            <h1 className="text-4xl md:text-5xl font-extralight tracking-tight">Land <span className="font-normal">Analyzer</span></h1>
          </div>
          <p className="text-lg text-muted-foreground max-w-2xl">Estimate carrying costs, acquisition basis, and build or resale scenarios.</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 rounded-2xl bg-foreground text-background text-center">
              <p className="text-xs font-semibold text-muted-foreground/70 uppercase tracking-wider mb-2">All-In Basis</p>
              <p className="text-5xl font-bold">${fmt(allInBasis)}</p>
            </div>
            <div className={`p-6 rounded-full text-center ${estimatedEquity >= 0 ? "bg-secondary border border-emerald-100" : "bg-red-50 border border-red-100"}`}>
              <p className="text-xs font-semibold text-muted-foreground/70 uppercase tracking-wider mb-2">Estimated Equity at Completion</p>
