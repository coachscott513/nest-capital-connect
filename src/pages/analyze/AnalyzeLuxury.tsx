      ...
      <section className="pt-32 pb-8 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-rose-50 flex items-center justify-center"><Gem className="w-7 h-7 text-gray-900" /></div>
          ...
          <p className="text-lg text-gray-500 max-w-2xl">Estimate true carrying cost, taxes, insurance, HOA, and cash needed to close.</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 rounded-3xl bg-gray-900 text-white text-center">
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Total Monthly Carry</p>
              <p className="text-5xl font-bold">${fmt(total)}</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100 text-center">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Annual Cost</p>
