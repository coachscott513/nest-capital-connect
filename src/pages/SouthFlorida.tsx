    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 pt-32 pb-20">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight text-background tracking-tight mb-8 leading-[1.05]">
            South Florida Real Estate,<br />
            <span className="font-normal">Explained Clearly</span>
          </h1>
          <p className="text-xl md:text-2xl text-background/80 font-light max-w-2xl mx-auto mb-12 leading-relaxed">
      ...
      <section className="py-32 px-6 bg-secondary/40">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-extralight text-foreground tracking-tight mb-6">
            Not Just Listings.<br />
            <span className="font-normal">Real Guidance.</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-20 font-light leading-relaxed">
      ...
      {/* FEATURED AREAS */}
      <section id="areas" className="py-32 px-6 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold tracking-[0.2em] uppercase text-muted-foreground/70 mb-4">Explore the Market</p>
            <h2 className="text-4xl md:text-6xl font-extralight text-foreground tracking-tight">
              Featured Areas
            </h2>
          </div>
            ...
            {areas.map((area) => (
              <div key={area.name} className="group relative rounded-3xl overflow-hidden aspect-[4/3] cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <h3 className="text-2xl font-semibold text-background mb-2">{area.name}</h3>
                  <p className="text-background/70 text-sm leading-relaxed">{area.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-32 px-6 bg-secondary/40">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-sm font-semibold tracking-[0.2em] uppercase text-muted-foreground/70 mb-4">Your First Step</p>
              <h2 className="text-4xl md:text-5xl font-extralight text-foreground tracking-tight mb-6 leading-tight">
                Financing Starts<br />
      ...
      <section className="py-32 px-6 bg-background">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold tracking-[0.2em] uppercase text-muted-foreground/70 mb-4">Cost Intelligence</p>
            <h2 className="text-4xl md:text-6xl font-extralight text-foreground tracking-tight mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              >
                <p className={`text-xs font-semibold uppercase tracking-wider mb-3 ${stat.highlight ? "text-muted-foreground/70" : "text-muted-foreground/70"}`}>
                  {stat.label}
                </p>
                <p className={`text-3xl md:text-4xl font-bold mb-2 ${stat.highlight ? "text-background" : "text-foreground"}`}>
                  {stat.value}
                </p>
                {stat.sub && (
                  <p className={`text-sm ${stat.highlight ? "text-muted-foreground/70" : "text-muted-foreground"}`}>{stat.sub}</p>
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-32 px-6 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold tracking-[0.2em] uppercase text-muted-foreground/70 mb-4">Your Edge</p>
            <h2 className="text-4xl md:text-6xl font-extralight text-foreground tracking-tight mb-6">
      ...
      <section className="py-32 px-6 bg-secondary/40">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-extralight text-foreground tracking-tight mb-6">
      ...
      <section id="contact" className="py-32 px-6 bg-background">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-extralight text-foreground tracking-tight mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 p-10 rounded-3xl border border-border/50 bg-secondary/50">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <Input id="sf-name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Your name" className="mt-2 bg-background border-border text-foreground placeholder:text-muted-foreground/70 rounded-xl h-12" />
              </div>
              <div>
                <Label htmlFor="sf-email" className="text-foreground/80 text-sm font-medium">Email *</Label>
                <Input id="sf-email" type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder="your@email.com" className="mt-2 bg-background border-border text-foreground placeholder:text-muted-foreground/70 rounded-xl h-12" />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <Label htmlFor="sf-phone" className="text-foreground/80 text-sm font-medium">Phone</Label>
                <Input id="sf-phone" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder="(555) 123-4567" className="mt-2 bg-background border-border text-foreground placeholder:text-muted-foreground/70 rounded-xl h-12" />
              </div>
              <div>
                <Label htmlFor="sf-timeline" className="text-foreground/80 text-sm font-medium">Timeline</Label>
                <select id="sf-timeline" value={formData.timeline} onChange={(e) => setFormData({ ...formData, timeline: e.target.value })} className="mt-2 w-full bg-background border border-border text-foreground rounded-xl h-12 px-3 text-sm">
            ...
            <div>
              <Label htmlFor="sf-interest" className="text-foreground/80 text-sm font-medium">I'm interested in...</Label>
              <select id="sf-interest" value={formData.interest} onChange={(e) => setFormData({ ...formData, interest: e.target.value })} className="mt-2 w-full bg-background border border-border text-foreground rounded-xl h-12 px-3 text-sm">
            ...
            <Button type="submit" disabled={isSubmitting} className="w-full bg-foreground text-background hover:bg-foreground/85 rounded-xl h-14 text-lg font-semibold">
      ...
      {/* POWERED BY */}
      <section className="py-12 px-6 bg-secondary/40 text-center">
        <p className="text-sm text-muted-foreground/70 tracking-wider">
          Powered by <span className="font-semibold text-muted-foreground">Capital District Nest</span> Property Intelligence
        </p>
      </section>
