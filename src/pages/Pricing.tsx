...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    price: "$15",
    cadence: "per month",
    tagline: "Stand out across search, town pages, and local discovery.",
    features: [
      "Everything in Free",
      "Priority placement in search & town directory",
      "“Featured Member” badge on every card",
      "10-photo high-definition gallery",
      "Long-form business description",
      "Interactive social media showcase",
  ...
  },
  {
    ...
    features: [
      ...
      "Premium local partner positioning",
    ],
