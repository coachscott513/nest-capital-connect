          ...
          <section className="py-8 px-4">
            <div className="max-w-[1000px] mx-auto">
              ...
              <div className="my-8 text-center bg-muted/30 p-8 rounded-lg">
                <h3 className="text-2xl font-semibold mb-3">Get Albany Land Opportunities</h3>
                <p className="text-muted-foreground mb-6 text-lg">Tell us your criteria and we&apos;ll send matching parcels + next steps.</p>
                <iframe
                  src="https://scottalvarez.remax.com/contact.php"
                  title="Land Opportunities Contact Form"
