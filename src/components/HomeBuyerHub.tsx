...
const HomeBuyerHub = () => {
  const hubSections = [
    ...
    },
    {
      ...
      links: [
        { label: "Albany Neighborhoods", href: "/living-in/albany" },
        { label: "Troy Neighborhoods", href: "/living-in/troy" },
        { label: "Schenectady Areas", href: "/living-in/schenectady" },
        { label: "Saratoga County", href: "/living-in/saratoga-springs" },
        { label: "Delmar & Bethlehem", href: "/living-in/delmar" },
    ...
    },
    {
      ...
      links: [
        { label: "Delmar Schools (Bethlehem CSD)", href: "/living-in/delmar" },
        { label: "Niskayuna Schools", href: "/living-in/niskayuna" },
        { label: "All Communities", href: "/communities" },
      ],
    },
  ];
