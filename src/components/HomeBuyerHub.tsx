...
const HomeBuyerHub = () => {
  const hubSections = [
    ...
    },
    {
      ...
      links: [
        { label: "Albany Neighborhoods", href: "/albany-real-estate" },
        { label: "Troy Neighborhoods", href: "/troy-real-estate" },
        { label: "Schenectady Areas", href: "/schenectady-real-estate" },
        { label: "Saratoga County", href: "/saratoga-real-estate" },
        { label: "Delmar & Bethlehem", href: "/delmar-homes-for-sale" },
    ...
    },
    {
      ...
      links: [
        { label: "Delmar Schools (Bethlehem CSD)", href: "/delmar-homes-for-sale" },
        { label: "Niskayuna Schools", href: "/schenectady-real-estate" },
