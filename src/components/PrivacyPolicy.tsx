  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-background">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-foreground mb-4 flex items-center">
            <Cookie className="w-6 h-6 mr-2 text-accent" />
          ...
          <div className="bg-yellow-50 p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Used to deliver relevant ads and track campaigns</p>
              </div>
            </div>
            
            <div className="mt-6 p-4 bg-background rounded border-l-4 border-accent">
              ...
              <ul className="text-sm text-foreground/80 mt-2 ml-4 list-disc">
              ...
              <p className="text-sm text-foreground/80 mt-2">
                You can opt out of personalized Facebook ads by adjusting your <a href="https://www.facebook.com/ads/preferences" target="_blank" rel="noopener noreferrer" className="text-accent underline">Facebook Ad Preferences</a> or by using the <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-accent underline">Digital Advertising Alliance opt-out tool</a>.
              </p>
            </div>

            <div className="mt-4 p-4 bg-background rounded border-l-4 border-green-500">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div className="border border-border p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Learn more about <a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener noreferrer" className="text-accent underline">Meta's Privacy Policy</a>.
              </p>
            </div>
            <div className="border border-border p-4 rounded-lg">
          ...
          <div className="bg-red-50 p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Industry-standard data centers</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-2">
                ...
                <p className="text-sm text-muted-foreground">Limited access on need-to-know basis</p>
              </div>
            </div>
          </div>
        </section>
