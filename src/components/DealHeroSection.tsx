    ...
    <>
      <section className="relative overflow-hidden bg-background">
        <div className="absolute inset-0">
          <div className="absolute top-1/3 right-1/4 w-[700px] h-[700px] rounded-full bg-primary/5 blur-[200px]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-primary uppercase tracking-widest">Live MLS Data</span>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/homes-for-sale"
                  className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-xl font-bold text-lg hover:brightness-110 transition-all"
                >
                  Browse 101 Deals
