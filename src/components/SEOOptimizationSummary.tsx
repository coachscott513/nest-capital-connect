  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="text-2xl font-bold text-blue-600">{optimizationMetrics.contentOptimization.blogPostsOptimized}</div>
            <div className="text-sm text-gray-600">Blog Posts Optimized</div>
          </div>
          <div className="bg-green-50 p-4 rounded-lg">
            <div className="text-2xl font-bold text-green-600">{optimizationMetrics.contentOptimization.keywordDensity}</div>
            <div className="text-sm text-gray-600">"For Sale" Keyword Density</div>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg">
            <div className="text-2xl font-bold text-purple-600">{optimizationMetrics.contentOptimization.internalLinks}</div>
            <div className="text-sm text-gray-600">Strategic Internal Links</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">Crawlability:</span>
      ...
      <div className="mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <div className="font-medium text-gray-700 mb-2">Target Locations:</div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600">Local Citations:</span>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-lg border border-green-200">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-gray-600">Current Average Position:</span>
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Success Confidence:</span>
