...
const SchenectadyRentalsSection = () => {
  return (
    <section id="schenectady-rentals" className="py-16 px-4 bg-gradient-to-br from-purple-50 to-violet-100">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <a 
              ...
              className="inline-block bg-purple-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-700 transition-colors duration-300 shadow-md hover:shadow-lg"
            >
