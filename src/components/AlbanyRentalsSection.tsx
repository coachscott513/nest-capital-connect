...
const AlbanyRentalsSection = () => {
  return (
    <section id="albany-rentals" className="py-16 px-4 bg-gradient-to-br from-green-50 to-emerald-100">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <a 
              ...
              className="inline-block bg-green-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-green-700 transition-colors duration-300 shadow-md hover:shadow-lg"
            >
