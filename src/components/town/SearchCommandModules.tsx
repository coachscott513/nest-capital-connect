...
const MODULES = [
  ...
  },
  {
    ...
    icon: Building2,
    placeholderTemplate: (town: string) => `Run the numbers on ${town} multi-units...`,
    description: "2–4 unit & apartment buildings",
  },
  {
    id: "rehab",
    label: "Find Fixer-Uppers",
    icon: Wrench,
    placeholderTemplate: (town: string) => `Find fixer-uppers in ${town}...`,
    description: "Value-add & renovation plays",
  },
  {
    id: "land",
    label: "Search Lots & Land",
    icon: TreePine,
    placeholderTemplate: (town: string) => `Search lots & land in ${town}...`,
