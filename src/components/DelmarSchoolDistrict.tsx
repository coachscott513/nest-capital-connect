              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-1">{school.grades}</p>
                    <p className="text-xs text-muted-foreground">{school.type}</p>
                  </div>
                  <div className="flex items-center gap-1 bg-emerald/15 px-3 py-1 rounded-full">
                ...
                <div className="pt-4 border-t border-border">
                  <div className="text-xs text-muted-foreground mb-2">GreatSchools Rating</div>
