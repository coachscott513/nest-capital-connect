    ...
    <section className="py-16 md:py-20 bg-report-bg">
      <div className="container mx-auto px-4 max-w-4xl">
        <article className="bg-report-card rounded-2xl shadow-[0_6px_24px_rgba(0,0,0,0.06)] border border-report-border p-8 md:p-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 mb-12">
            {costItems.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="p-6 rounded-2xl bg-report-section-light border border-report-border text-center"
                >
          ...
          {/* Total Monthly */}
          <div className="text-center mb-12 p-8 rounded-2xl bg-report-section-light border border-report-border max-w-sm mx-auto">
          ...
          {isUnlocked && taxHistory.length > 0 && (
            <div className="max-w-2xl mx-auto bg-report-section-light rounded-2xl border border-report-border p-8">
              <p className="text-sm text-report-text-body font-medium text-center mb-6">
                Tax Trend (5–10 Years)
              </p>
