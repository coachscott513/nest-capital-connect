        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 max-w-md mx-auto mb-8">
          <div className="space-y-6">
            <div className="space-y-3">
              <Label className="text-base font-medium text-white">What are you looking for?</Label>
              <RadioGroup value={searchType} onValueChange={(value) => setSearchType(value as "rent" | "buy")}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="rent" id="rent" />
                  <Label htmlFor="rent" className="text-white">Rent</Label>
                </div>
                <div className="flex items-center space-x-2">
            ...
            {searchType === "buy" && (
              <div className="space-y-3">
                <Label className="text-base font-medium text-white">Property Type</Label>
                <RadioGroup value={propertyType} onValueChange={(value) => setPropertyType(value as "single-family" | "multi-unit")}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="single-family" className="text-white">Single-Family Home</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="multi-unit" id="multi-unit" />
                    <Label htmlFor="multi-unit" className="text-white">Multi-Unit Home</Label>
                  </div>
                </RadioGroup>
              </div>
            )}
            ...
            {(searchType === "rent" || (searchType === "buy" && propertyType)) && (
              <div className="space-y-3">
                <Label className="text-base font-medium text-white">Select County</Label>
