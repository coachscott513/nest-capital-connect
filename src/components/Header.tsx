        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-1 bg-blue-800 rounded-2xl shadow-xl p-2 hidden group-hover:block min-w-56 border border-blue-700/50">
              ...
              <Link to="/living-in/delmar" className="block px-4 py-2 text-white hover:bg-blue-700 rounded-md text-sm">Delmar Homes</Link>
              ...
              <div className="border-t border-blue-700 my-2"></div>
              <Link to="/living-in/albany" className="block px-4 py-2 text-white hover:bg-blue-700 rounded-md text-sm">Albany Real Estate</Link>
              <Link to="/living-in/troy" className="block px-4 py-2 text-white hover:bg-blue-700 rounded-md text-sm">Troy Real Estate</Link>
              <Link to="/living-in/schenectady" className="block px-4 py-2 text-white hover:bg-blue-700 rounded-md text-sm">Schenectady Real Estate</Link>
              <Link to="/living-in/saratoga-springs" className="block px-4 py-2 text-white hover:bg-blue-700 rounded-md text-sm">Saratoga Real Estate</Link>
            </div>
          </div>
          <div className="relative group">
            <button className="text-white hover:bg-background/10 px-3 py-2 rounded-md transition-colors duration-200 text-sm font-medium">
