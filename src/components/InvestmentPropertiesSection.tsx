      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-primary-foreground/70 max-w-4xl mx-auto leading-relaxed">
            ...
            to <Link to="/#rehab-properties" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">fix & flip investments</Link>, we connect you with the best deals in <Link to="/living-in/albany" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">Albany</Link>, <Link to="/living-in/troy" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">Troy</Link>, <Link to="/living-in/schenectady" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">Schenectady</Link>, and <Link to="/living-in/saratoga-springs" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">Saratoga</Link>. Need <Link to="/#financing" className="text-blue-300 hover:text-blue-200 hover:underline transition-colors">financing solutions</Link>? We've got you covered.
          </p>
        </div>
