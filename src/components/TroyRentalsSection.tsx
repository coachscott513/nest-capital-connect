...
const TroyRentalsSection = () => {
  return (
    <section id="troy-rentals" className="py-16 px-4 bg-gradient-to-br from-orange-50 to-amber-100">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <a 
              href="https://scottalvarez.remax.com/index.php?advanced=1&display=Troy&min=0&max=100000000&beds=0&baths=0&types%5B%5D=6&statuses%5B%5D=0&minfootage=0&maxfootage=30000&minacres=0&maxacres=0&yearbuilt=0&maxyearbuilt=0&walkscore=0&keywords=&pak=city%3Ag30_dree57z2&sortby=listings.price+ASC&rtype=map&leadid=948"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-orange-700 transition-colors duration-300 shadow-md hover:shadow-lg"
            >
