        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <Card className="border-red-200 bg-white hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-sm text-gray-600">Median List Price</div>
          ...
          <Card className="border-blue-200 bg-white hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-3xl font-bold text-gray-900 mb-1">{avgDOM}</div>
          ...
          <Card className="border-purple-200 bg-white hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-sm text-gray-600">Active Inventory</div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-medium text-gray-700">Delmar</span>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-blue-600">$212/sqft</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
